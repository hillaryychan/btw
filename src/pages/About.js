  ...
  return (
    <Container className="mt-2">
      ...
      <p>
        ...
        <ul>
          <li>
            When I&apos;ve talked about something (i.e.
            checked/crossed/completed it), it still exists on the checklist with
            a <strike>strikethrough</strike> and makes the list cluttered over
            time. I don&apos;t really need to see crossed out items <i>on</i>{" "}
            the list itself; I may want to view it at a later point but that has
            hardly ever been the case
          </li>
          <li>
          ...
          <li>
            ...
            line to express it. Sure we can have sub-items, but that
            doesn&apos;t work for rambling thoughts and musings that are meant
            to supplement my idea instead of being an extra sub-idea I want to
            point out
          </li>
        </ul>
